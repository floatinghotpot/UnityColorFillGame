...
public class GUIEasyTouchMenu : Editor {
	...
	[MenuItem ("Tools/EasyTouch/Add EasyTouch for C#")]
	static void  AddEasyTouch4C(){
		GUIEasyTouchMenu.AddEasyTouch(true);
	}

	[MenuItem ("Tools/EasyTouch/Add EasyTouch for javascript")]
	static void  AddEasyTouch4Java(){
		GUIEasyTouchMenu.AddEasyTouch(false);
	}
	
	[MenuItem ("Tools/EasyTouch/Extensions/Adding a new joystick")]
	...
	[MenuItem ("Tools/EasyTouch/Extensions/Adding a new button")]
