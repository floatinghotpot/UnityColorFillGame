...
public class GUIEasyJoystickInspector : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (t.showAppearance){
			...
			if (t.showOutTexture) GUI.backgroundColor = Color.green; else GUI.backgroundColor = Color.red;
			t.showOutTexture = EditorGUILayout.Toggle("Out Texture", t.showOutTexture);
			GUI.backgroundColor = Color.white;
			if (t.showOutTexture)
			{
				t.outTexture = (Texture)EditorGUILayout.ObjectField("Out Texture", t.outTexture, typeof(Texture),true);
			}
