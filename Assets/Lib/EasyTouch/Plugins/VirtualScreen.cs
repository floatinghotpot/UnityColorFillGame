...
public class VirtualScreen :  MonoSingleton<VirtualScreen> {
	...
	#region Members
	public float virtualWidth = 1136;
	public float virtualHeight = 640;
	
	public static float width = 1136;
	public static float height = 640;
    ...
    //public static float GetScrrenHight(UIPanel panel)
    //{
    //    float iHight = panel.GetWindowSize().y;
    //    if(Screen.height == 2436 && Screen.width == 1125)
    //    {
    //        iHight -= (140 * 1385 / 2436);
    //    }
    //    return iHight;
    //}
}
